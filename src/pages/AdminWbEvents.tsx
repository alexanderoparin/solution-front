...
const WB_TYPE_LABELS: Record<WbApiEventType, string> = {
  CONTENT_CARDS_LIST_PAGE: 'Артикулы кабинета',
  ...
  ANALYTICS_SALES_FUNNEL_NMID: 'Воронка продаж по артикулу',
  PRICES_CABINET_WITH_SPP: 'Цены + СПП (кабинет)',
  PROMOTION_COUNT: 'РК кабинета - статусы',
  PROMOTION_ADVERTS_BATCH: 'Группа РК - детали',
  PROMOTION_STATS_BATCH: 'Дневная статистика РК',
  PROMOTION_NORMQUERY_STATS_BATCH: 'Статистика по кластерам',
  PROMOTION_CAMPAIGN_START: 'Биддер - запуск РК',
  PROMOTION_CAMPAIGN_PAUSE: 'Биддер - пауза РК',
  PROMOTION_BALANCE: 'Промо: баланс кабинета',
  PROMOTION_BUDGET_GET: 'Биддер - бюджет РК',
  PROMOTION_BUDGET_DEPOSIT: 'Промо: пополнение бюджета РК',
  ANALYTICS_ITEM_RATING_CABINET: 'Рейтинги артикулов',
  PROMOTION_CALENDAR_SYNC_CABINET: 'Список акций кабинета',
  PROMOTION_CALENDAR_NOMENCLATURES: 'Список артикулов в акции',
  WAREHOUSES_SYNC_CABINET: 'Склады WB: кабинет',
  STOCKS_BY_NMID: 'Остатки артикула FBO',
  FBS_WAREHOUSES_SYNC_CABINET: 'Склады продавца FBS: кабинет',
  FBS_STOCKS_CABINET: 'Остатки кабинета FBS',
