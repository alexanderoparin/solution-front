                ...
                >
                  {(() => {
                    ...
                    const latestStocksUpdate = stocks.length > 0
                      ...
                      : null
                    const fullDate = latestStocksUpdate ? dayjs(latestStocksUpdate).format('DD.MM.YY HH:mm') : null
                    const headerNode = (
                      <h2
                        style={{
                          ...typography.h2,
                          ...
                          whiteSpace: 'nowrap',
                          flexShrink: 0,
                          cursor: fullDate ? 'help' : undefined,
                        }}
                      >
                        Остатки
                      </h2>
                    ...
                    return fullDate ? (
                      <Tooltip title={`Обновлено ${fullDate}`}>{headerNode}</Tooltip>
                    ) : (
                      headerNode
                    )
                  })()}
                  ...
                  {(() => {
                    ...
                    return (
                      <div
                        ...
                        style={{ cursor: 'help', marginLeft: 'auto', flexShrink: 0 }}
                      >
                        <div
                          style={{
                            ...typography.h3,
